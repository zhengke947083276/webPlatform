...
<%@include file="/WEB-INF/jsp/item/delete.jsp"%>
<%@include file="/WEB-INF/jsp/item/update.jsp"%>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- 按钮触发模态框 -->
                                            <a href="#" onclick="update(${item.itemId},'${item.itemName}','${item.itemGitUrl}','${item.itemDescribe}',${item.itemState})" class="btn btn-primary"  data-toggle="modal" data-target="#itemUpdate">修改</a>
                                            <!-- 按钮触发模态框 -->
                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="" disabled="disabled">升级</a>
                                            <!-- 按钮触发模态框 -->
                                            <a href="#" onclick="del(${item.itemId})" class="btn btn-primary" data-toggle="modal" data-target="#itemDelete">删除</a>
                                        </td>
                                    </tr>
                                </table>
                            </div>
